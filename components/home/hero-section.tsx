...
export default function HeroSection() {
    return (
        ...
        <div className="mt-8 sm:mt-12">
          <Button
            variant={'link'}
            className="text-base text-white mt-4 sm:text-lg lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-4 sm:py-7 lg:py-8 bg-gradient-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 hover:no-underline font-bold shadow-lg transition-all duration-300"
          >
