  ...
  return (
    <section className="flex items-center justify-center min-h-[50vh] px-6 bg-[#fdfdfd] dark:bg-[#1a1a1a]">
      <div className="text-center space-y-6 max-w-xl bg-white dark:bg-[#2a2a2a] p-8 rounded-2xl shadow-md border border-[#f5f5f5] dark:border-[#333]">
        {/* Icon */}
        <div className="mx-auto flex items-center justify-center w-16 h-16 rounded-full bg-gray-200 dark:bg-amber-900">
          <File className="h-8 w-8 text-amber-500 dark:text-amber-300" />
        </div>

        {/* Message */}
        <div className="space-y-2">
          <h2 className="text-2xl font-semibold text-amber-600 dark:text-amber-200">
            No summaries yet
          </h2>
        ...
        {/* Call to action */}
        <Link href="/upload">
          <Button className="px-6 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-xl transition-colors duration-300">
